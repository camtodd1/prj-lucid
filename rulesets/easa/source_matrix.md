...
| Controlling lower envelope | Derived from source-backed Chapter H/J candidate surfaces | Supported generated contract; required Category II/III OFZ candidates are included, EHTE Code 2B NI/NPA comparison, EHAM Code 4F CAT II/III, EHRD Code 4C CAT I, and EGLL dual-parallel Code 4F CAT II/III fixtures pass strict topology, determinism, and performance gates, and independent technical review has passed |
