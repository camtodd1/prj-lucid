...
* **Threshold markings** — The number of longitudinal stripes is
  ...
  and 16 stripes respectively【463838982788260†L184-L198】.  Although
  ...
  stripes should be “approximately 1.80 m wide”【463838982788260†L215-L220】.
...
* **Centreline markings** — CS ADR‑DSN.L.530 requires that
  ...
  code 1/2 non‑precision and non‑instrument runways 0.30 m【463838982788260†L145-L164】.
...
* **Aiming point markings** — Table L‑1 of CS ADR‑DSN.L.540 sets
  ...
  (<800 m, 800 m–<1 200 m, 1 200 m–<2 400 m and ≥2 400 m)【463838982788260†L288-L333】.
...
* **Touchdown‑zone markings** — CS ADR‑DSN.L.545 specifies that
  ...
  the aiming point should be omitted【463838982788260†L389-L435】.  The
  number of pairs increases with LDA: one pair for LDA < 900 m,
  two for 900 m–<1 200 m, three for 1 200 m–<1 500 m, four for
  1 500 m–<2 400 m, and six for LDA ≥ 2 400 m【463838982788260†L390-L407】.
...
# ranges permitted by the specification【463838982788260†L288-L333】.
AIMING_POINT_RULES = (
...
# band have been omitted【463838982788260†L389-L435】.
...
def centreline_marking_width(arc_num: int, type_primary: str, type_reciprocal: str) -> float:
    ...
    approach category and aerodrome code number【463838982788260†L145-L164】.
...
def aiming_point_rule(
    ...
    (LDA)【463838982788260†L288-L333】.  This function returns the first
    ...
    desired【463838982788260†L274-L286】.  For runways 30 m in width or
...
def touchdown_zone_offsets(lda_m: float) -> List[float]:
    ...
    List[float]
        ...
        given LDA band【463838982788260†L390-L407】.
    """
