...
During pairwise competition, exact planar-vs-planar cuts are applied before
curved conical-vs-planar cuts. This preserves the planar boundary network first,
then lets conical intersections trim the already-established planar regions.
