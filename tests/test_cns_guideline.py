...
from frameworks.nasf.cns import get_cns_spec, slope_contour_levels
...
class CnsGuidelineTests(unittest.TestCase):
    def test_satellite_ground_station_has_explicit_overlapping_height_bands(self):
        ...
        self.assertTrue(by_name["Zone A"]["Referral"].startswith("Refer"))
        ...
        self.assertTrue(by_name["Area of Interest"]["Referral"].startswith("Refer"))
