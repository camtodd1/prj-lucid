...
<qgis version="3.40.5-Bratislava" styleCategories="AllStyleCategories" labelsEnabled="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fieldName="CASE WHEN round(&quot;contagl_m&quot; * 2) / 2 = floor(round(&quot;contagl_m&quot; * 2) / 2) THEN format_number(round(&quot;contagl_m&quot; * 2) / 2, 0) ELSE format_number(round(&quot;contagl_m&quot; * 2) / 2, 1) END" isExpression="1" fontFamily="Helvetica" fontSize="10" fontSizeUnit="Point" textColor="0,82,94,255" fontWeight="50">
