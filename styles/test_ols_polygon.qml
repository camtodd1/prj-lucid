...
<qgis autoRefreshMode="Disabled" autoRefreshTime="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" layerType="Vector" maxScale="0" minScale="100000000" readOnly="0" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" symbologyReferenceScale="-1" version="4.0.2-Norrköping">
  ...
  <temporal accumulate="0" durationField="elev_min" durationUnit="min" enabled="0" endExpression="" endField="" fixedDuration="0" limitMode="0" mode="0" startExpression="" startField="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <aliases>
    <alias field="surface_id" index="0" name=""/>
    <alias field="surface" index="1" name=""/>
    <alias field="model" index="2" name=""/>
    <alias field="elev_min" index="3" name=""/>
    <alias field="elev_max" index="4" name=""/>
