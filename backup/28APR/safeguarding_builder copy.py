...
class SafeguardingBuilder:
    ...
    def run_safeguarding_processing(self):
        ...
        self.style_map = { "ARP": "arp_point.qml", 
          ...
          "PreThreshold Runway": "default_zone_polygon.qml",
        ...
        if processed_runway_data_list and any_runway_base_data_ok:
            ...
            if physical_geom_group:
                ...
                # <<< ADD End_Desig TO PRE-THRESHOLD FIELDS >>>
                ...
                # <<< ADD NEW STYLE KEY MAPPING >>>
                style_key_map = {
                  "Runway": "Runway Pavement",
                  "PreThresholdRunway": "PreThreshold Runway", # <<< NEW
    ...
    def generate_physical_geometry(self, runway_data: dict) -> Optional[List[Tuple[str, QgsGeometry, dict]]]:
      ...
      # <<< NO CHANGE to this section's core logic - uses original thr_point/rec_thr_point >>>
      ...
      # --- 1b. Pre-Threshold Runway Areas (Displaced Areas) --- <<< NEW SECTION >>>
      if runway_width is not None and runway_width > 0:
...
# ============================================================
    ...
    def _generate_tocs(self, runway_data: dict, rwy_params: dict, arc_num: int, end_type: str,
        ...
        try:
          ...
          QgsMessageLog.logMessage(f"DEBUG _generate_tocs Pre-Convert Types: offset={type(origin_offset)}, slope={type(slope)}", PLUGIN_TAG, level=Qgis.Info)
          ...
          slope = float(slope)
          # <<< DEBUG LOG 5 (After Conversion) >>>
          QgsMessageLog.logMessage(f"DEBUG _generate_tocs Post-Convert Types: offset={type(origin_offset)}, slope={type(slope)}", PLUGIN_TAG, level=Qgis.Info)
