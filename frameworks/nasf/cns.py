    ...
    "VHF Omni-Directional Range (VOR)": [
        {
            ...
            "HeightBasis": "AGL",
            "ActionRequired": "All applications must be referred to Airservices Australia for assessment.",
            "Condition": "Within 100 m of the generic VOR antenna, regardless of height.",
            "FacilityLabel": "VOR",
            "SourceRef": "User-confirmed generic VOR parameters",
            "Guidance": "",
        },
        {
            ...
            "HeightBasis": "AGL",
            "ActionRequired": "All applications must be referred to Airservices Australia for assessment.",
            "Condition": "Between 100 m and 1,500 m from the generic VOR antenna; no additional height criterion.",
            "FacilityLabel": "VOR",
            "SourceRef": "User-confirmed generic VOR parameters",
            "Guidance": "",
        },
    ...
    "Middle and Outer Marker Beacon": [
        {
            ...
            "HeightBasis": "AGL",
            "ActionRequired": "All applications must be referred to Airservices Australia for assessment.",
            "Condition": "Within 5 m of the marker beacon antenna, regardless of height.",
            "FacilityLabel": "Marker Beacon",
            "SourceRef": "Airservices Building Restrictions Guide, Attachment 3, Middle and Outer Marker Beacon",
            "Guidance": "Within 5 m of the marker beacon, grass and other vegetation should be less than 0.6 m tall.",
        },
        {
            "SurfaceName": "Zone A - 50 Degree Slope",
            "shape": "Donut",
            "OuterRadius_m": 50,
            "InnerRadius_m": 5,
            "HeightRule": "Radial Slope",
            "HeightBasis": "AGL",
            "SlopeDegrees": 50,
            "SlopeStartHeightAGL_m": 5 * math.tan(math.radians(50)),
            "SlopeStartDistance_m": 5,
            "ContourInterval_m": 5,
            "ActionRequired": "All applications must be referred to Airservices Australia for assessment.",
            "Condition": "Between 5 m and 50 m from the marker beacon antenna and crosses the 50 degree zone boundary measured from ground level at the antenna.",
            "FacilityLabel": "Marker Beacon",
            "SourceRef": "Airservices Building Restrictions Guide, Attachment 3, Middle and Outer Marker Beacon",
            "Guidance": "Within 5 m of the marker beacon, grass and other vegetation should be less than 0.6 m tall.",
        },
        {
            ...
            "HeightBasis": "AGL",
            "ActionRequired": "No requirements.",
            "Condition": "Between 5 m and 50 m from the marker beacon antenna and does not cross the 50 degree Zone A boundary.",
            "FacilityLabel": "Marker Beacon",
            "SourceRef": "Airservices Building Restrictions Guide, Attachment 3, Middle and Outer Marker Beacon",
            "Guidance": "Within 5 m of the marker beacon, grass and other vegetation should be less than 0.6 m tall.",
        },
    ...
    "Primary Surveillance Radar (PSR)": [
        {
            ...
            "HeightBasis": "AGL",
            "ActionRequired": "All applications must be referred to Airservices Australia for assessment.",
            "Condition": "Within 500 m of the PSR antenna, regardless of height. Modelled to ground level because antenna height is not collected; the source guide specifies development above a horizontal plane 4 m below the antenna base.",
            "FacilityLabel": "PSR",
            "SourceRef": "Airservices Building Restrictions Guide, Attachment 3, p. 32",
            "Guidance": "No temporary or permanent obstructions should infringe Zone A or Zone B. Sharp discontinuities in the area of interest, such as single metal light towers, power pylons, and city buildings, will impact performance and should be avoided where possible.",
        },
        {
            "SurfaceName": "Zone B - 0.5 Degree Slope",
            "shape": "Donut",
            "OuterRadius_m": 4000,
            "InnerRadius_m": 500,
            "HeightRule": "Radial Slope",
            "HeightBasis": "AGL",
            "SlopeDegrees": 0.5,
            "SlopeStartHeightAGL_m": 500 * math.tan(math.radians(0.5)),
            "SlopeStartDistance_m": 500,
            "ContourInterval_m": 5,
            "ActionRequired": "All applications must be referred to Airservices Australia for assessment.",
            "Condition": "Between 500 m and 4,000 m from the PSR antenna and crosses the 0.5 degree Zone B boundary. The source measures this from 8 m below antenna height; the model uses ground level because antenna height is not collected.",
            "FacilityLabel": "PSR",
            "SourceRef": "Airservices Building Restrictions Guide, Attachment 3, p. 32",
            "Guidance": "No temporary or permanent obstructions should infringe Zone A or Zone B. Sharp discontinuities in the area of interest, such as single metal light towers, power pylons, and city buildings, will impact performance and should be avoided where possible.",
        },
        {
            "SurfaceName": "Area of Interest - 0.25 Degree Slope",
            "shape": "Donut",
            "OuterRadius_m": 15000,
            "InnerRadius_m": 4000,
            "HeightRule": "Radial Slope",
            "HeightBasis": "AGL",
            "SlopeDegrees": 0.25,
            "SlopeStartHeightAGL_m": 4000 * math.tan(math.radians(0.25)),
            "SlopeStartDistance_m": 4000,
            "ContourInterval_m": 5,
            "ActionRequired": "All applications must be referred to Airservices Australia for assessment.",
            "Condition": "Between 4,000 m and 15,000 m from the PSR antenna and crosses the 0.25 degree area-of-interest boundary. The source measures this from antenna height; the model uses ground level because antenna height is not collected.",
            "FacilityLabel": "PSR",
            "SourceRef": "Airservices Building Restrictions Guide, Attachment 3, p. 32",
            "Guidance": "No temporary or permanent obstructions should infringe Zone A or Zone B. Sharp discontinuities in the area of interest, such as single metal light towers, power pylons, and city buildings, will impact performance and should be avoided where possible.",
        },
    ...
    "Secondary Surveillance Radar (SSR)": [
        {
            ...
            "HeightBasis": "AGL",
            "ActionRequired": "All applications must be referred to Airservices Australia for assessment.",
            "Condition": "Within 500 m of the SSR antenna, regardless of height. Modelled to ground level because antenna height is not collected; the source guide specifies development above a horizontal plane 4 m below the antenna base.",
            "FacilityLabel": "SSR",
            "SourceRef": "Airservices Building Restrictions Guide, Attachment 3, p. 32",
            "Guidance": "No temporary or permanent obstructions should infringe Zone A or Zone B. Sharp discontinuities in the area of interest, such as single metal light towers, power pylons, and city buildings, will impact performance and should be avoided where possible.",
        },
        {
            ...
            "ContourInterval_m": 5,
            "ActionRequired": "All applications must be referred to Airservices Australia for assessment.",
            "Condition": "Between 500 m and 4,000 m from the SSR antenna and crosses the 0.5 degree Zone B boundary. The source measures this from 8 m below antenna height; the model uses ground level because antenna height is not collected.",
            "FacilityLabel": "SSR",
            "SourceRef": "Airservices Building Restrictions Guide, Attachment 3, p. 32",
            "Guidance": "No temporary or permanent obstructions should infringe Zone A or Zone B. Sharp discontinuities in the area of interest, such as single metal light towers, power pylons, and city buildings, will impact performance and should be avoided where possible.",
        },
        {
            ...
            "ContourInterval_m": 5,
            "ActionRequired": "All applications must be referred to Airservices Australia for assessment.",
            "Condition": "Between 4,000 m and 15,000 m from the SSR antenna and crosses the 0.25 degree area-of-interest boundary. The source measures this from antenna height; the model uses ground level because antenna height is not collected.",
            "FacilityLabel": "SSR",
            "SourceRef": "Airservices Building Restrictions Guide, Attachment 3, p. 32",
            "Guidance": "No temporary or permanent obstructions should infringe Zone A or Zone B. Sharp discontinuities in the area of interest, such as single metal light towers, power pylons, and city buildings, will impact performance and should be avoided where possible.",
        },
...
LEGACY_CNS_FACILITY_TYPE_ALIASES = {
    ...
    "MIDDLE AND OUTER MARKER": "Middle and Outer Marker Beacon",
}
...
def classified_contour_heights(
    start_height_m: float,
    maximum_height_m: float,
    primary_interval_m: float,
    intermediate_interval_m: float,
) -> List[Dict[str, Any]]:
    """Return primary/intermediate contour heights using the shared CNS policy."""
    try:
        start_height = float(start_height_m)
        maximum_height = float(maximum_height_m)
        primary_interval = float(primary_interval_m)
        intermediate_interval = float(intermediate_interval_m)
    except (TypeError, ValueError):
        return []
    if primary_interval <= 0 or intermediate_interval <= 0 or maximum_height < start_height:
        return []
...
def slope_contour_levels(
    ...
    for contour in classified_contour_heights(
        start_height,
        maximum_height,
        primary_interval,
        intermediate_interval,
    ):
        height = contour["height_agl_m"]
